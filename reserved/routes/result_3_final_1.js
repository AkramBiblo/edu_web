...
const resultArray = [
  ...
  [
    ...
    (AllSubjects = [
      ...
      (FullMarks = [100, 100, 100, 100, 100, 100, 100, 100, 75, 50, 50, 50, 50, 25]),
      (passMarks = [40, 40, 40, 40, 40, 40, 40, 40, 30, 20, 20, 20, 20, 10]),
  ],
  [
    (cid = "7"),
    (className = "Class 7"),
                                ...
                                for (const data in result) {
                                    if (Object.hasOwnProperty.call(result, data)) {
                                        ...
                                        new Promise((resolve, reject) => {
                                            ...
                                            first_term_allMarks = [[arabic, islamiat, bangla, english, math, drawing, GK, handWriting, AGM], [calculatedGrade], [gradeObtained], [lg], [gp], [finalGPA]];
                                ...
                                for (const data in result) {
                                    if (Object.hasOwnProperty.call(result, data)) {
                                        ...
                                        new Promise((resolve, reject) => {
                                            ...
                                            first_term_allMarks = [[quranTazbeed, islamiat, arabic, bangla, english, math, drawing, GK, handWriting, AGM], [calculatedGrade], [gradeObtained], [lg], [gp], [finalGPA]];
                                            resolve(first_term_allMarks)
                                        })
                                    }
                                }
                        ...
                        let annual_term_allMarks = [];
                                for (const data in result) {
                                    if (Object.hasOwnProperty.call(result, data)) {
                                        ...
                                        new Promise((resolve, reject) => {
                                            first_term_allMarks = [[quranTazbeed, islamiat, arabic, bangla, english, math, spokenArabic, spokenEnglish, wordBook, computer, drawing, GK, AGM, handWriting], [calculatedGrade], [gradeObtained], [lg], [gp], [finalGPA]];
                                            resolve(first_term_allMarks)
                                        })
                                    }
                                }
                        ...
                        let annual_term_allMarks = [];
                                for (const data in result) {
                                    if (Object.hasOwnProperty.call(result, data)) {
                                        ...
                                        new Promise((resolve, reject) => {
                                            first_term_allMarks = [[quranTazbeed, islamiat, arabic, math, banglaWithGrammar, englishWithGrammar, science, BGS, GK, wordBook, spokenEnglish, spokenArabic, AGM], [calculatedGrade], [gradeObtained], [lg], [gp], [finalGPA]];
                                            resolve(first_term_allMarks)
                                        })
                                    }
                                }
                        ...
                        let annual_term_allMarks = [];
                                for (const data in result) {
                                    if (Object.hasOwnProperty.call(result, data)) {
                                        ...
                                        new Promise((resolve, reject) => {
                                            first_term_allMarks = [[quranTazbeed, arabic, bangla, english, islamiat, math, mizan, BGS, science, QN, MTZT, spokenArabic, spokenEnglish, computer, wordBook, TM, AGM], [calculatedGrade], [gradeObtained], [lg], [gp], [finalGPA]];
                                            resolve(first_term_allMarks)
                                        })
                                    }
                                }
                ...
                if (result.length <= 0) {
                    ...
                    for (const data in result) {
                        if (Object.hasOwnProperty.call(result, data)) {
                            ...
                            new Promise((resolve, reject) => {
                                first_term_allMarks = [[hadith, arabic, mizan, bangla, english, math, aqaed, FM, QN, quranTazbeed, BGS, science, spokenArabic, spokenEnglish, computer, AGM], [calculatedGrade], [gradeObtained], [lg], [gp], [finalGPA]];
                                resolve(first_term_allMarks)
                            })
                        }
                    }
                    ...
                    if (result.length <= 0) {
                        ...
                        for (const data in result) {
                            if (Object.hasOwnProperty.call(result, data)) {
                                ...
                                new Promise((resolve, reject) => {
                                    first_term_allMarks = [[hadith, arabic, arabic_2, mizan, bangla, english, math, aqaed, BGS, QN, quranTazbeed, ICT, science, AGM], [calculatedGrade], [gradeObtained], [lg], [gp], [finalGPA]];
                                    resolve(first_term_allMarks)
                                })
                            }
                        }
